package com.zhsnddn.index12306.ticketservice.service.handler.ticket.select;
...
import com.zhsnddn.index12306.ticketservice.common.enums.VehicleSeatTypeEnum;
import com.zhsnddn.index12306.ticketservice.common.enums.VehicleTypeEnum;
import com.zhsnddn.index12306.ticketservice.dao.entity.TrainStationPriceDO;
import com.zhsnddn.index12306.ticketservice.dao.mapper.TrainStationPriceMapper;
...
import com.zhsnddn.index12306.ticketservice.remote.UserRemoteService;
import com.zhsnddn.index12306.ticketservice.remote.dto.PassengerRespDTO;
import com.zhsnddn.index12306.ticketservice.service.SeatService;
...
public final class TrainSeatTypeSelector {
    ...
    public List<TrainPurchaseTicketRespDTO> select(Integer trainType, PurchaseTicketReqDTO requestParam) throws RemoteException {
